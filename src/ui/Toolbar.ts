...
const ICONS: Record<Tool, string> = {
  ...
  fluid: `<svg viewBox="0 0 ${S} ${S}" width="${S}" height="${S}"><circle cx="6" cy="11" r="2.5" fill="rgba(70,150,255,0.85)" stroke="currentColor" stroke-width="0.8"/><circle cx="10" cy="8" r="2.5" fill="rgba(70,150,255,0.65)" stroke="currentColor" stroke-width="0.8"/><circle cx="13" cy="12" r="2.5" fill="rgba(70,150,255,0.75)" stroke="currentColor" stroke-width="0.8"/></svg>`,
  ...
  slime: `<svg viewBox="0 0 ${S} ${S}" width="${S}" height="${S}"><rect x="3" y="5" width="12" height="8" rx="2" fill="rgba(80,180,255,0.3)" stroke="currentColor" stroke-width="1.3"/><path d="M5 5q0-1.5 4-1.5t4 1.5" fill="none" stroke="currentColor" stroke-width="0.8"/><path d="M5 13q0 1.5 4 1.5t4-1.5" fill="none" stroke="currentColor" stroke-width="0.8"/></svg>`,
